...
function [permutedIndices, boundaryCells, interiorCells, hpart, vpart] = ...
    IndexPermutation3DThreeDCubicLattice(N,divx, divy, divz)
    %N = [10 10 10];
    ...
    for i = 1:3*(N(1)*N(2)*N(3))
       ...
       elseif( y == Ny/divy || y == Ny/divy -0.5 || y == Ny/divy+0.5 || y == Ny/divy+1)
           ...
           boundaryCellIndex = [boundaryCellIndex; i];
           bounder = bounder+1;    
       elseif( z == Nz/divz || z == Nz/divz -0.5 || z == Nz/divz+0.5 || z == Nz/divz+1)
           boundaryCells=[ boundaryCells; startIndex];
           boundaryCellIndex = [boundaryCellIndex; i];
           bounder = bounder+1;    
       else
