function [ A, omega,b, Sxf, Dxf, Dyf, sxf, syf,trun] = solveTE_Matrices_parallel(L0, wvlen, xrange, yrange, eps_r, Mz, Npml)
%% Input Parameters
...
%% Create Matrix Terms
spmd
    Term1 = Dxf_pml*(Tepx^-1)*Dxb_pml;
    Term2 = Dyf_pml*(Tepy^-1)*Dyb_pml;
end
%% Construct the matrix A, everything is in 2D
A = Term1 + Term2 + omega^2*Tmz;
