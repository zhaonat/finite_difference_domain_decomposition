%% Parallel IterativeFourBlockSchur
%% best for large number of parallel workers, like in 
function [Aschur, bmod, App, Avvcell, Apvcell, Avpcell, bvCell,...
    SchurComplements, SchurSources] = ...
    ParallelFourBlockSchurSingleSep(SymA, SymB, hpart, vpart, ...
    xCells, yCells, N, SingleCellSize)
