function [Aschur, bmod, App, Avvcell, Apvcell, Avpcell, bvCell, InvAvvStorage, Aint] = ...
    ...
    %% now we need to map the particular parts of Aint...because each schur complement only maps itself on
    %% a subset of Aint
