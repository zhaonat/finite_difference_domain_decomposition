function [x,flag,iter,Miter,QLPiter,relres,relAres,...
	...
	csminresqlp(A,b,rtol,maxit,M,shift,maxxnorm,Acondlim,TranCond,show)
...
%
%   X = csminresqlp(A,B,RTOL,MAXIT,M,SHIFT)
...
%   Default SHIFT=0.
%
%   X = csminresqlp(A,B,RTOL,MAXIT,M,SHIFT,MAXXNORM,ACONDLIM,TRANCOND)
